...
{
    wp_register_script('maskinput', get_stylesheet_directory_uri() . '/functions-modules/validate_billing_phone_number/jquery.maskinput.js', array('jquery'), '1.4.1', true);
    wp_enqueue_script('maskinput');
    wp_register_script('maskphone', get_stylesheet_directory_uri() . '/functions-modules/validate_billing_phone_number/maskphone.js', array('jquery'), '1.0.0', true);
